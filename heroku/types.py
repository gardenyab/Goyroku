...
class Module:
    ...
    async def _decline(
        ...
        await call.edit(
            ...
            photo="https://raw.githubusercontent.com/gardenyab/Goyroku/refs/heads/master/assets/goyroku_dclj.png",
        )
    ...
    async def request_join(
        ...
        await self.inline.bot.send_photo(
            self.tg_id,
            "https://raw.githubusercontent.com/gardenyab/Goyroku/refs/heads/master/assets/goyroku_joinr.png",
            caption=(
